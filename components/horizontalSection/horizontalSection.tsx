              ...
              <div className="flex-1 text-center max-w-5xl">
                ...
                <div className="leading-6 sm:leading-7">
                  ...
                  <LinkPreview className="border-b pb-1" url="https://www.fftt.com/site/personnes/by-number?number_id=904998">
                    tennis de table en compétition et suis actuellement classé 11
                  </LinkPreview>
                  &nbsp;, la musculation, mais je suis également l’esport, un domaine qui allie stratégie et passion pour les jeux vidéo.
                </div>
              </div>
            </div>
          </div>
