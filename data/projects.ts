...
export const projectsPro: Project[] = [
  ...
  },
  {
    ...
    featured: true,
    period: "2026",
    context: "Projet perso — pensé pour les associations",
    tagline: "Le cashless repensé pour les besoins des associations.",
    description:
      "Une solution de paiement sans espèces pour les événements associatifs, sans commission et sans matériel coûteux : les participants ont un bracelet QR rechargeable, les bénévoles encaissent sur une caisse tactile, et l'association suit tout en temps réel.",
    highlights: [
      "Gratuit pour les associations, opérationnel en quelques minutes",
      "Caisse tactile par catégories d'articles, encaissement au scan du bracelet QR",
      "Tableau de bord en temps réel : soldes, crédits, débits, ventes par article",
      "Gestion des bénévoles et des participants, invitations par email, export CSV",
    ],
